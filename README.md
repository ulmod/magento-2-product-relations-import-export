...
With Magento 2 Product Relations Import and Export, you can easily create product links/relation or transfer up-sell, cross-sell, and related products between Magento 2 sites or installations. 
...
* Export an and import unlimited number of up-sell, cross-sell, and related products into a CSV file
* Ability to export by store view, product status, product type, product visibility, product ID range
* Support two profile types: export and import. Ability to create any number of export/import profiles for different tasks
* Support all types of products 
* Support two import behavior: Add/Replace and Delete
...
* Support export history, ability to manage all product links/relationship export log from the backend
* Ability to delete product links/relationship export logs manually or automatically


<img src="https://www.ulmod.com/media/ulmod/product_content/relation-export-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/relation-import-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/relation-history-f.png">
